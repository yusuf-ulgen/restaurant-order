...
> **Binding Authority:** This file is a lightweight adapter for GPT-based tools. You **must** read and adhere to the master instructions in [AGENTS.md](../AGENTS.md) before performing any operation.
