...
| **5. Kalite Kapısı & Script Testleri** | `node --test scripts/tests/*.test.mjs` | `PASS` | [scripts/tests/](../scripts/tests/) (34/34 test: file-size, docs, secrets, blue-green, blue-green-resilience, blue-green-flow) | Dağıtım script mantığında regresyon | CI Gate 4 ile otomatik doğrulama |
...
| **10. .NET Entegrasyon Testleri** | `pnpm test:integration` | `PASS` | [tests/integration/TestcontainersIntegrationTests.cs](../tests/integration/TestcontainersIntegrationTests.cs) (15/15 test, Testcontainers Redis 7 & Postgres 16) | Canlı yüksek yük altında gecikmeler | Yük testleri planlanacak |
